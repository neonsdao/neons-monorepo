import { publicDiscordWebhook } from './clients';
...
if (config.discordEnabled) {
  ...
  auctionLifecycleHandlers.push(new DiscordAuctionLifecycleHandler([publicDiscordWebhook]));
}
...
async function processAuctionTick() {
  ...
  if (secondsUntilAuctionEnds < 90 && cachedAuctionEndingSoon < lastAuctionId) {
