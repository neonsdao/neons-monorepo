...
const GovernancePage = () => {
  ...
  const nounSingular = <Trans>Neon</Trans>;
  const nounPlural = <Trans>Neons</Trans>;
    ...
    <Section fullWidth={false} className={classes.section}>
      <Col lg={10} className={classes.wrapper}>
        <Row className={classes.headerRow}>
          ...
          <h1>
            <Trans>Neons Treasury</Trans>
          </h1>
        </Row>
        <p className={classes.subheading}>
          Neons govern the <span className={classes.boldText}>Neons Treasury</span>. Neons can vote
          on proposals or delegate their vote to a third party. A minimum of{' '}
        ...
        <Row className={classes.treasuryInfoCard}>
          ...
          <Col className={classes.treasuryInfoText}>
            <Trans>
              This treasury exists for <span className={classes.boldText}>Neons</span> participants
              to allocate resources for the long-term growth and prosperity of the Neons project.
            </Trans>
          </Col>
        </Row>
