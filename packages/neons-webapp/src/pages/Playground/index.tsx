...
import { ImageData, getNounData, getRandomNounSeed } from '@neons/assets';
import { buildSVG, EncodedImage, PNGCollectionEncoder } from '@neons/sdk';
...
const nounsAssetsLink = (
  <Link
    text="neons-assets"
    url="https://github.com/nounsDAO/neons-monorepo/tree/master/packages/neons-assets"
    leavesPage={true}
  />
);
...
const nounsSDKLink = (
  <Link
    text="neons-sdk"
    url="https://github.com/nounsDAO/neons-monorepo/tree/master/packages/neons-sdk"
    leavesPage={true}
  />
);
