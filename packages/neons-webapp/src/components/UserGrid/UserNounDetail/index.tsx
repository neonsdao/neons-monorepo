...
import classes from './UserNounDetail.module.css';
import { ImageData } from '@neons/assets';
...
const UserNounDetail: React.FC<UserNounDetailProps> = props => {
        ...
        >
          ...
          >
            {nounId !== null && seed ? (
              ...
              <Image src={loadingNoun} alt="Loading neon" />
            )}
          </div>
