...
import config, { CHAIN_ID, SupportedChainIds } from '../../config';
...
const WalletConnectModal: React.FC<{ onDismiss: () => void }> = props => {
  ...
  const supportedChainIds = SupportedChainIds;
      ...
      <WalletButton
        onClick={() => {
          const walletlink = new WalletLinkConnector({
            appName: 'Neons.LOL',
            appLogoUrl: 'https://neons.lol/static/media/logo.cdea1650.svg',
      ...
      {/* <WalletButton
        onClick={() => {
          const trezor = new TrezorConnector({
            chainId: CHAIN_ID,
            url: config.app.jsonRpcUri,
            manifestAppUrl: 'https://neons.lol',
