    ...
    <AuctionActivityWrapper>
      <div className={auctionActivityClasses.informationRow}>
        <Row className={auctionActivityClasses.activityRow}>
          ...
          <Col lg={12}>
            <AuctionActivityNounTitle isCool={isCool} nounId={nounId} />
          </Col>
        </Row>
        <Row className={auctionActivityClasses.activityRow}>
      ...
      <Row className={auctionActivityClasses.activityRow}>
        <Col lg={12}>
          <ul className={auctionBidClasses.bidCollection}>
            ...
            >
              <Trans>All Neon auction proceeds are sent to the</Trans>{' '}
              <Link to="/vote" className={nounContentClasses.link}>
                <Trans>Neons</Trans>
              </Link>
              .{' '}
              <Trans>
                For this reason, we, the project's founders (‘The Shadowy Cabal of Agent Smiths’)
                have chosen to compensate ourselves with Neons. Every 10th Neon will be sent to our
                multi-sig, where it will be vested and distributed to individual Neonders.
              </Trans>
            </li>
          </ul>
        </Col>
